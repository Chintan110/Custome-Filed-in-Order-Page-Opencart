...
class ControllerLocalisationCity extends Controller {
	...
	protected function getList() {
		...
		$data['sort_name'] = $this->url->link('localisation/city', 'user_token=' . $this->session->data['user_token'] . '&sort=z.name' . $url, true);
		$data['sort_code'] = $this->url->link('localisation/city', 'user_token=' . $this->session->data['user_token'] . '&sort=z.code' . $url, true);
	...
	protected function getForm() {
		...
		$data['zones'] = $this->model_localisation_city->getRegion();
